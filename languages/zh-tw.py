...
'Commit to Delete': 'Commit to Delete',
'Community': 'Community',
...
'enter an integer between %(min)g and %(max)g': 'enter an integer between %(min)g and %(max)g',
'Enter valid IP address': 'Enter valid IP address',
...
'Modules': '程式模組',
'must be format {IP} for single IP and {IP}:{IP}:... for multiple IPs': 'must be format {IP} for single IP and {IP}:{IP}:... for multiple IPs',
'My Sites': 'My Sites',
'Name': '名字',
'New Record': '新紀錄',
